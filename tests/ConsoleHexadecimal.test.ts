...
describe("console", () => {
  ...
  const samples = [
    ...
    ["simplified 40 bytes", Buffer.from("hello".repeat(8)), PrintHexadecimalPreset.SIMPLIFIED],
    ["UINT8 1 byte", Buffer.from([0]), PrintHexadecimalPreset.UINT8],
    ["INT8 1 byte", Buffer.from([0]), PrintHexadecimalPreset.INT8],
    ["UINT8 5 bytes", Buffer.from([10, 20, 30, 40, 250]), PrintHexadecimalPreset.UINT8],
    ["INT8 5 bytes", Buffer.from([10, 20, 30, 40, 250]), PrintHexadecimalPreset.INT8],
    [
      "INT8 26 bytes",
      Buffer.from([
    ...
    ["UINT16_LE 5 bytes", Buffer.from([10, 20, 30, 250, 250]), PrintHexadecimalPreset.UINT16_LE],
    ["INT16_LE 5 bytes", Buffer.from([10, 20, 30, 250, 250]), PrintHexadecimalPreset.INT16_LE],
    ["UINT32_LE 5 bytes", Buffer.from([10, 20, 30, 250, 250]), PrintHexadecimalPreset.UINT32_LE],
    ["INT32_LE 5 bytes", Buffer.from([10, 20, 30, 250, 250]), PrintHexadecimalPreset.INT32_LE],
    [
      "FLOAT_LE 9 bytes",
      Buffer.from([0x42, 0xf6, 0xe9, 0x79, 0x79, 0xe9, 0xf6, 0x42, 0x00]),
      PrintHexadecimalPreset.FLOAT_LE,
    ],
    ["UINT16_BE 5 bytes", Buffer.from([10, 20, 30, 250, 250]), PrintHexadecimalPreset.UINT16_BE],
    ["INT16_BE 5 bytes", Buffer.from([10, 20, 30, 250, 250]), PrintHexadecimalPreset.INT16_BE],
    ["UINT32_BE 5 bytes", Buffer.from([10, 20, 30, 250, 250]), PrintHexadecimalPreset.UINT32_BE],
    ["INT32_BE 5 bytes", Buffer.from([10, 20, 30, 250, 250]), PrintHexadecimalPreset.INT32_BE],
    [
      "FLOAT_BE 9 bytes",
      Buffer.from([0x42, 0xf6, 0xe9, 0x79, 0x79, 0xe9, 0xf6, 0x42, 0x00]),
